...
function App() {
  ...
  const selectPhoto = (index: number, direction = index > activePhoto ? 1 : -1) => {
    ...
    timeline.to(caption, { opacity: 0, duration: .35, ease: 'power2.out' })
      ...
      .fromTo(nextCaption, { x: -30, opacity: 0 }, { x: 0, opacity: 1, duration: .65, ease: 'power3.out' }, '-=.55')
