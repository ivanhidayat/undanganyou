...
const countdownTarget = new Date('2026-10-05T07:00:00+07:00').getTime()
...
const episodes = [
  ...
  { id: 'ep03', tag: 'EP 03', title: '03 Awal Selamanya', image: '/story/episode-03.jpg', text: 'Atas kehendak Allah SWT menuntun keyakinan kami untuk mengikrarkan janji suci pernikahan kami pada 05 - 06 Oktober 2026.' },
]
const photos = [
...
function App() {
  ...
  const playStory = () => {
    ...
    const steps = [[1, 1000], [2, 2000], [3, 3000]] as const
  ...
  const addToCalendar = () => {
    ...
    calendarUrl.searchParams.set('dates', '20261005T000000Z/20261006T100000Z')
      ...
      {tab === 'home' && <>
        <section className="hero-panel">
          <div className="hero-copy">
            ...
            <p className="meta"><b>2026</b><b className="rating">SU</b><span>Senin - Selasa</span><span>05 - 06 Oktober 2026</span></p>
