...
function App() {
  ...
  const selectPhoto = (index: number, direction = index > activePhoto ? 1 : -1) => {
    ...
    if (!next || !image || !nextImage || !background || !caption || galleryAnimatingRef.current || index === activePhoto) return
